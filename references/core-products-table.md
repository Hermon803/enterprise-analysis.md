...
1. **全部产品数据必须通过网络搜索核实最新发布版本**，不可仅依赖已有知识
2. **按发布时间降序排列**（最新产品排在最前面）
3. **实体企业** → 选 **至少4个不同领域** 最具代表性的产品（如：华为→麒麟芯片、旗舰手机、华为云、问界汽车）
4. **半导体设备企业** → 选不同产品线设备（如：格芯→AOI检测、分选机、晶圆检测、激光打标）
5. **互联网/软件公司** → 展示核心App或服务（如：微信、腾讯云、腾讯视频、腾讯游戏）
6. **产品名称列** 加粗，产品介绍列简要说明（一行以内，避免换行）
7. **至少4行**，不足时从次要产品中补充
8. **发布时间** 精确到月份，不确定的标注年份（如"2020年"），切勿编造具体日期
