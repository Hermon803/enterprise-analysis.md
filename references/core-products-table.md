...
1. **访问官网产品页获取在售最新产品**（如 consumer.huawei.com/cn/phones/、nvidia.com），从页面提取产品名称和发布时间信息
2. **提取发布时间**：优先从页面HTML的日期标记（如 `2025-11`、`2025年6月`）、meta description、URL路径中获取。官网无明确日期则搜索科技媒体发布记录
3. **如果网络不可达**，使用已有知识但标注"发布时间为估计值"
4. **按发布时间降序排列**（最新产品排在最前面）
5. **实体企业** → 选 **至少4个不同领域** 最具代表性的产品（如：华为→手机、AI芯片、云服务、汽车）
6. **互联网/软件公司** → 展示核心App或服务（如：微信、腾讯云、腾讯视频、腾讯游戏）
7. **产品名称列** 加粗，产品介绍列简要说明（一行以内，避免换行）
8. **至少4行**，不足时从次要产品中补充
9. **发布时间** 精确到月份，不确定的标注年份（如"2020年"），切勿编造具体日期
